...
for i=1:thenumberofcells
    ...
    for time=1:(length(d2b)-3)
        ...
        filename3=horzcat('05182015_TF_9kPa_Position001_t',num2str(time,'%04d'),'_4.mat');
        filename3=horzcat('05182015_TF_9kPa_Position001_t',num2str(time,'%04d'),'_5.mat');
        save(filename1,'A1');
        save(filename2,'A2');
        save(filename3,'A3');
        save(filename3,'A4');
