...
%    pixval on; axis ij; 
   ...
   phase = strcat('C:\Singlecell\croppeddata\',cellfolder,'\BF\',phasetemp(1:n-1),'_ch02.tif');
...
%        for j = 1 : timepts-1,
%         if j <=9,
%            copyfile(d2bbound(i).name, strcat(d2bbound(i).name(1:13),'00',num2str(j), d2bbound(i).name(17:22)));
%         else
%             if j <=99,
%             copyfile(d2bbound(i).name, strcat(d2bbound(i).name(1:13),'0',num2str(j), d2bbound(i).name(17:22)));
%             else
%                 copyfile(d2bbound(i).name, strcat(d2bbound(i).name(1:13),num2str(j), d2bbound(i).name(17:22)));
%             end;
%         end;
%        end;
%    end;
