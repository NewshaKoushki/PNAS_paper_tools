...
fdate = 'rawdata';
folds  = {'Cell140'}; % cell folder to analyze 
...
%%mkdir(strcat('\HTSbart\croppeddata\',cellfolder,'\BigFB'));
    ...
    if  ~isempty(findstr(d2tryp(count).name,'Pos'))&...
            ~isempty(findstr(d2tryp(count).name,'t999')),% name must  contain Pos
          	si = si + 1;
      end;    
    end;
    pos = si/nchannels
    ...
    for posn = 1 : pos,% CHANGED THIS TO GET VALUES FROM FIRST ROW OF DISHES
        ...
        if  posn <= 9, 
        FB = strcat('Pos00',num2str(posn),'_S001_t999_ch00.tif');
        BigFB = strcat('Pos00',num2str(posn),'_S001_t999_ch01.tif');
        BF = strcat('Pos00',num2str(posn),'_S001_t999_ch02.tif');
        else
        FB = strcat('Pos0',num2str(posn),'_S001_t999_ch00.tif');
        BigFB = strcat('Pos0',num2str(posn),'_S001_t999_ch01.tif');
        BF = strcat('Pos0',num2str(posn),'_S001_t999_ch02.tif');
        end;
        ...
        if  posn <= 9,
                  if time <= 10,
        name2 = strcat('Pos00',num2str(posn),'_S001_t00',num2str(time-1),'_ch00.tif');
                  else
                      if time <= 100,
            ...
            if time <= 10,
        name2 = strcat('Pos0',num2str(posn),'_S001_t00',num2str(time-1),'_ch00.tif')
            else
                      if time <= 100,
                      name2 = strcat('Pos00',num2str(posn),'_S001_t0',num2str(time-1),'_ch00.tif')
                      else
...
%       
    FB_S002    = strcat(FB(1:10),num2str(2),FB(12:25));
    name2_S002 = strcat(name2(1:10),num2str(2),name2(12:25))
...
%            
       ...
       if posn <= 9,
        ...
        name4 = strcat('Pos00',num2str(posn),'_S001_t00',num2str(time-1),'_ch02.tif');
        else
                      if time <= 100,
                      name4 = strcat('Pos00',num2str(posn),'_S001_t0',num2str(time-1),'_ch02.tif');
                      else
                          name4 = strcat('Pos00',num2str(posn),'_S001_t',num2str(time-1),'_ch02.tif');
                  end;
           end;
       else
            if time <= 10,              
                          
        name4 = strcat('Pos0',num2str(posn),'_S001_t00',num2str(time-1),'_ch02.tif');
        else
                      if time <= 100,
                      name4 = strcat('Pos0',num2str(posn),'_S001_t0',num2str(time-1),'_ch02.tif');
                      else
                          name4 = strcat('Pos0',num2str(posn),'_S001_t',num2str(time-1),'_ch02.tif');
                  end;
           end;
      ...
      im4 			= double(imread(name4)); 
       ...
       BF_S002    = strcat(BF(1:10),num2str(2),BF(12:25));
       name4_S002 = strcat(name4(1:10),num2str(2),name4(12:25));
      ...
      imwrite(uint8(im4_S001),['C:\Singlecell\croppeddata\' cellfolder '\BF\' name4],'tif');
       ...
       if posn <= 9,
        ...
        name5 = strcat('Pos00',num2str(posn),'_S001_t00',num2str(time-1),'_ch01.tif');
        else
                      if time <= 100,
                      name5 = strcat('Pos00',num2str(posn),'_S001_t0',num2str(time-1),'_ch01.tif');
                      else
                          name5 = strcat('Pos00',num2str(posn),'_S001_t',num2str(time-1),'_ch01.tif');
                  end;
           end;
        ...
        name5 = strcat('Pos0',num2str(posn),'_S001_t00',num2str(time-1),'_ch01.tif');
        else
                      if time <= 100,
                      name5 = strcat('Pos0',num2str(posn),'_S001_t0',num2str(time-1),'_ch01.tif');
                      else
                          name5 = strcat('Pos0',num2str(posn),'_S001_t',num2str(time-1),'_ch01.tif');
                  end;
           end;
       end;
      ...
      im5 			= double(imread(name5)); 
       ...
       BigFB_S002    = strcat(BF(1:10),num2str(2),BF(12:25));
       name5_S002 = strcat(name5(1:10),num2str(2),name5(12:25));
