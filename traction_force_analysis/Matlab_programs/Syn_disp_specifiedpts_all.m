...
header   = '';       
     ...
     xlswrite(data1,header,colnames,xlsfilename1,cellfolder);     
     xlswrite(data2,header,colnames,xlsfilename2,cellfolder); 
     xlswrite(data3,header,colnames,xlsfilename3,cellfolder); 
     xlswrite(data4,header,colnames,xlsfilename4,cellfolder); 
