...
%        for j = 1 : timepts-1,
%         if j <=9,
%            copyfile(d2bbound(i).name, strcat(d2bbound(i).name(1:14),num2str(j), d2bbound(i).name(16:25)));
%         else
%             copyfile(d2bbound(i).name, strcat(d2bbound(i).name(1:13),num2str(j), d2bbound(i).name(16:25)));
%         end;
%        end;
%    end;
