...
fdate = 'rawdata';
folds  = {'A8_c1_1';'A8_c1_2';'M8_c1_1'}; % cell folder to analyze 
...
%%mkdir(strcat('\HTSbart\croppeddata\',cellfolder,'\BigFB'));
    ...
    for posn = 1 : pos,% CHANGED THIS TO GET VALUES FROM FIRST ROW OF DISHES
        ...
        BigFB = strcat('Pos00',num2str(posn),'_S001_t99_ch02.tif');
        BF = strcat('Pos00',num2str(posn),'_S001_t99_ch01.tif');
        else
        FB = strcat('Pos0',num2str(posn),'_S001_t99_ch00.tif');
        BigFB = strcat('Pos0',num2str(posn),'_S001_t99_ch02.tif');
        BF = strcat('Pos0',num2str(posn),'_S001_t99_ch01.tif');
        end;
...
%            
       ...
       if posn <= 9,
        ...
        name4 = strcat('Pos00',num2str(posn),'_S001_t0',num2str(time-1),'_ch01.tif');
                      ...
                      if time <= 100,
                      name4 = strcat('Pos00',num2str(posn),'_S001_t',num2str(time-1),'_ch01.tif');
                      else
                          name4 = strcat('Pos00',num2str(posn),'_S001_t',num2str(time-1),'_ch01.tif');
                  end;
           end;
...
%       imwrite(uint8(im4_S002),['C:\Singlecell\croppeddata\' cellfolder '\BF\' name4_S002],'tif');
       ...
       if posn <= 9,
        ...
        name5 = strcat('Pos00',num2str(posn),'_S001_t0',num2str(time-1),'_ch02.tif');
                      ...
                      if time <= 100,
                      name5 = strcat('Pos00',num2str(posn),'_S001_t',num2str(time-1),'_ch02.tif');
                      else
                          name5 = strcat('Pos00',num2str(posn),'_S001_t',num2str(time-1),'_ch02.tif');
                  end;
           end;
