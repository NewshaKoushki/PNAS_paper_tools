...
%%mkdir(strcat('\HTSbart\croppeddata\',cellfolder,'\BigFB'));
    ...
    for posn = 1 : pos,% CHANGED THIS TO GET VALUES FROM FIRST ROW OF DISHES
        ...
        if  posn <= 9, 
        FB = strcat('Pos00',num2str(posn),'_S001_t99_z05_ch00.tif');
        BigFB = strcat('Pos00',num2str(posn),'_S001_t99_z05_ch01.tif');
        BF = strcat('Pos00',num2str(posn),'_S001_t99_z05_ch02.tif');
        else
        FB = strcat('Pos0',num2str(posn),'_S001_t99_z05_ch00.tif');
        BigFB = strcat('Pos0',num2str(posn),'_S001_t99_z05_ch01.tif');
        BF = strcat('Pos0',num2str(posn),'_S001_t99_z05_ch02.tif');
        end;
        ...
        if  posn <= 9,
                  if time <= 10,
        name2 = strcat('Pos00',num2str(posn),'_S001_t0',num2str(time-1),'_z05_ch00.tif')
                  else
                      name2 = strcat('Pos00',num2str(posn),'_S001_t',num2str(time-1),'_z05_ch00.tif')
                  end;
        else
            if time <= 10,
        name2 = strcat('Pos0',num2str(posn),'_S001_t0',num2str(time-1),'_z05_ch00.tif')
                  else
                      name2 = strcat('Pos0',num2str(posn),'_S001_t',num2str(time-1),'_z05_ch00.tif')
                  end;
...
%        
   ...
   FB_S002    = strcat(FB(1:10),num2str(2),FB(12:28));
   name2_S002 = strcat(name2(1:10),num2str(2),name2(12:28))
...
%        
       ...
       if  posn <= 9,
                  if time <= 10,
        name4 = strcat('Pos00',num2str(posn),'_S001_t0',num2str(time-1),'_z05_ch02.tif')
                  else
                      name4 = strcat('Pos00',num2str(posn),'_S001_t',num2str(time-1),'_z05_ch02.tif')
                  end;
        else
            if time <= 10,
        name4 = strcat('Pos0',num2str(posn),'_S001_t0',num2str(time-1),'_z05_ch02.tif')
                  else
                      name4 = strcat('Pos0',num2str(posn),'_S001_t',num2str(time-1),'_z05_ch02.tif')
                  end;
       end;
      ...
      BF_S002    = strcat(BF(1:10),num2str(2),BF(12:28));
      name4_S002 = strcat(name4(1:10),num2str(2),name4(12:28));
      ...
      imwrite(uint8(im4_S002),['C:\Singlecell\croppeddata\' cellfolder '\BF\' name4_S002],'tif');
       ...
       if posn <= 9,
        name5 = strcat('Pos00',num2str(posn),'_S001_t0',num2str(time-1),'_z05_ch01.tif');
           else
        name5 = strcat('Pos0',num2str(posn),'_S001_t',num2str(time-1),'_z05_ch01.tif'); 
       end;
      ...
      BigFB_S002    = strcat(BF(1:10),num2str(2),BF(12:28));
      name5_S002 = strcat(name5(1:10),num2str(2),name5(12:28));
